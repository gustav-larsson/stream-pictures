...
export interface ButtonsConfig {
  ...
  onApprove?: (onApproveData:OnApproveData, onApproveActions: OnApproveActions) => Promise<void>|void;

  onCancel?: (onCancelData: OnCancelData, onCancelActions: OnCancelActions) => Promise<void>|void;

  onShippingChange?: (onShippingChangeData: OnShippingChangeData, onShippingChangeActions: OnShippingChangeActions) => Promise<void>|void;
}
...
export interface CreateOrderActions {
  ...
  payment?: {
    create: (paymentRequest: PaymentRequest) => Promise<string>
  }
}
...
export type CreateSubscriptionActions = {
  subscription : {
    create : (subscriptionRequest: SubscriptionRequest) => Promise<string>,
    revise : (text: string, data: any) => Promise<string>
  }
}
...
export interface OnApproveActions {
  ...
  redirect: (text: string) => Promise<void>
}
